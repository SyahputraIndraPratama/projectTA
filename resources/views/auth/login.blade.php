...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ ('img/icon/eHRM-logo.png') }}" />
                                        ...
                                        <div class="col-lg-6">
                                            <div class="auth-content card-body p-5 h-100 text-white">
                                                <div class="w-100">
                                                    ...
                                                    <div class="mt-1">
                                                        <p class="mb-0">Tidak Punya Akun ? <a href="/register"
                                                                class="fw-medium text-white text-decoration-underline">
                                                                Daftar </a></p>
                                                    </div>
                                                    <div class="mt-1">
                                                        <p class="mb-0"><a href="{{ '/' }}"
                                                                class="fw-medium text-white"> Kembali </a></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
